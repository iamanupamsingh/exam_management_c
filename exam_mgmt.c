...
void execute()
{
	...
	case 3:
		printf("Old Attendance required = %f",min_attendance);
...
void printStudents(struct student s[])
{
	// Loop to iterate over the students students records
	for (i = 0; i < n; i++) {
